...
export default function Dashboard() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      {demoMode ? (
        <section className="rounded-[1.5rem] border border-orange-200 bg-orange-50 px-5 py-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <div className="text-sm font-bold text-orange-700">Demo mode</div>
              <p className="mt-1 text-sm leading-6 text-gray-600">
                For the cleanest walkthrough, start in lessons, jump to trading, then show the market and portfolio.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              <Link
                to="/lessons"
                className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-orange-700 ring-1 ring-orange-200 transition hover:bg-orange-100"
              >
                Open lessons
              </Link>
              {marketUnlocked ? (
