...
import { Award, ChevronRight, Flame, LogOut, Settings, Shield, Target, TrendingUp, Zap } from 'lucide-react';
          ...
          <section className="rounded-[1.75rem] border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-3">
              ...
              <button
                ...
                className="flex w-full items-center justify-between rounded-2xl bg-gray-50 px-4 py-4 text-left text-sm text-gray-700 hover:bg-gray-100"
              >
                <div className="flex items-center gap-3">
