...
const PATH_POSITIONS = ['items-start', 'items-center', 'items-end', 'items-center'];
const PATH_X_POSITIONS = [20.833, 50, 79.167, 50];
const PATH_STEP_HEIGHT = 220;
            ...
            <div className="mt-8">
              <div className="relative mx-auto flex max-w-3xl flex-col gap-4">
                ...
                {mod.lessons.map((lesson, index) => {
                  const positionClass = PATH_POSITIONS[index % PATH_POSITIONS.length];
                  ...
                  return (
                    <div key={lesson.id} className={`relative z-10 flex min-h-[220px] flex-col ${positionClass}`}>
                      <div className="relative w-full max-w-[20rem]">
                        ...
                        <div className={`mt-3 rounded-2xl border px-4 py-4 ${statusTone}`}>
